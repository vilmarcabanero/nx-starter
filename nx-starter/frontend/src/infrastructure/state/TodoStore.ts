...
import type { ITodoCommandService, ITodoQueryService, CreateTodoData, UpdateTodoData } from '@nx-starter/shared-application';
  ...
  subscribeWithSelector(
    devtools(
      immer((set, get) => {
        ...
        const getCommandService = () => container.resolve<ITodoCommandService>(TOKENS.TodoCommandService);
        const getQueryService = () => container.resolve<ITodoQueryService>(TOKENS.TodoQueryService);
