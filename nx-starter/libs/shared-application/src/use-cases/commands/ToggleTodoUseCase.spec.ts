...
describe('ToggleTodoUseCase', () => {
  ...
  describe('execute', () => {
    it('should toggle incomplete todo to completed', async () => {
      ...
      expect(mockRepository.update).toHaveBeenCalledWith('12345678901234567890123456789022', {
        completed: true
      });
    });
    ...
    it('should toggle completed todo to incomplete', async () => {
      ...
      expect(mockRepository.update).toHaveBeenCalledWith('12345678901234567890123456789023', {
        completed: false
      });
    });
    ...
    it('should handle repository errors during update', async () => {
      ...
      expect(mockRepository.getById).toHaveBeenCalledWith('12345678901234567890123456789022');
      expect(mockRepository.update).toHaveBeenCalledWith('12345678901234567890123456789022', {
        completed: true
      });
    });
    ...
    it('should check todo existence before toggling', async () => {
      ...
      // Assert
      expect(mockRepository.getById).toHaveBeenCalledBefore(mockRepository.update as any);
    });
