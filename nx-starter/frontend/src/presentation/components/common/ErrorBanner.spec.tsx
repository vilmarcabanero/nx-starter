...
describe('ErrorBanner', () => {
  ...
  describe('when there is an error', () => {
    ...
    it('should apply correct CSS classes for styling', () => {
      ...
      expect(errorBanner).toHaveClass('mb-6', 'p-4', 'bg-destructive/10', 'border', 'border-destructive/20', 'rounded-lg');
    });

    it('should handle long error messages', () => {
      const longError = 'This is a very long error message that might wrap to multiple lines and should be displayed properly in the error banner component without breaking the layout';
