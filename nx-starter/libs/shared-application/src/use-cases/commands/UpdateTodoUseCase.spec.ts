...
import { Todo, TodoNotFoundException, TodoTitle, TodoPriority } from '@nx-starter/shared-domain';
...
describe('UpdateTodoUseCase', () => {
  ...
  describe('execute', () => {
    it('should update todo title', async () => {
      ...
      expect(mockRepository.update).toHaveBeenCalledWith('12345678901234567890123456789016', {
