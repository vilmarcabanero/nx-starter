...
describe('DomainExceptions', () => {
  ...
  describe('InvalidTodoTitleException', () => {
    it('should create exception with custom reason', () => {
      ...
      expect(exception.message).toBe('Invalid todo title: Title cannot be empty');
    ...
    it('should handle different validation reasons', () => {
      ...
      const charactersException = new InvalidTodoTitleException('contains invalid characters');
      
      expect(emptyException.message).toBe('Invalid todo title: cannot be empty');
      expect(lengthException.message).toBe('Invalid todo title: too long');
      expect(charactersException.message).toBe('Invalid todo title: contains invalid characters');
    });
