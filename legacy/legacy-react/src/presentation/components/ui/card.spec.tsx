...
describe('Card Component Snapshots', () => {
  ...
  describe('CardTitle', () => {
    ...
    it('renders card title with custom className', () => {
      const { container } = render(<CardTitle className="custom-title">Custom Title</CardTitle>);
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  ...
  describe('CardDescription', () => {
    ...
    it('renders card description with custom className', () => {
      const { container } = render(<CardDescription className="custom-description">Custom Description</CardDescription>);
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  ...
  describe('CardAction', () => {
    ...
    it('renders card action with custom className', () => {
      const { container } = render(<CardAction className="custom-action">Custom Action</CardAction>);
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  ...
  describe('CardFooter', () => {
    ...
    it('renders card footer with custom className', () => {
      const { container } = render(<CardFooter className="custom-footer">Custom Footer</CardFooter>);
      expect(container.firstChild).toMatchSnapshot();
    });
  });
