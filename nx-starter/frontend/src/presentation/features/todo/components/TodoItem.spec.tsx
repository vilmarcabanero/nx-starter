...
describe('TodoItem', () => {
  ...
  it('should call updateTodo when save button is clicked in edit mode', async () => {
    ...
    await waitFor(() => {
      expect(mockStore.updateTodo).toHaveBeenCalledWith(mockTodo.numericId, { title: 'Updated Todo' });
    });
  });
  ...
  it('should handle update error gracefully', async () => {
    ...
    await waitFor(() => {
      expect(consoleSpy).toHaveBeenCalledWith('Failed to save edit:', expect.any(Error));
    });
  ...
  it('should not call toggleTodo when todo has no id', async () => {
    ...
    Object.defineProperty(todoWithoutId, 'numericId', { value: undefined, writable: false });
