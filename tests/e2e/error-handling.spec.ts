...
test.describe('Error Handling', () => {
  ...
  test.describe('Form Validation', () => {
    ...
    test('should clear validation error when valid input is entered', async ({ page }) => {
      const input = page.locator('[data-testid="todo-input"]');
      const button = page.locator('[data-testid="add-todo-button"]');
      ...
      await expect(page.locator('[data-testid="todo-input-error"]')).not.toBeVisible();
    });

    test('should disable add button when input is invalid', async ({ page }) => {
      const input = page.locator('[data-testid="todo-input"]');
      const button = page.locator('[data-testid="add-todo-button"]');
