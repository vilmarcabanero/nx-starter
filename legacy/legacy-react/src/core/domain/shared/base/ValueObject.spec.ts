...
describe('ValueObject', () => {
  describe('constructor and validation', () => {
    ...
    it('should throw error for invalid string value', () => {
      expect(() => new TestStringValueObject('')).toThrow('Value cannot be empty');
      expect(() => new TestStringValueObject('   ')).toThrow('Value cannot be empty');
    });

    it('should throw error for invalid number value', () => {
      expect(() => new TestNumberValueObject(-1)).toThrow('Value cannot be negative');
    });
    ...
    it('should validate complex object values', () => {
      expect(() => new TestObjectValueObject({ name: '', age: 25 }))
        .toThrow('Invalid object value');
      expect(() => new TestObjectValueObject({ name: 'John', age: -5 }))
        .toThrow('Invalid object value');
    });
  });
  ...
  describe('equals', () => {
    ...
    it('should return false when comparing with non-ValueObject', () => {
      ...
      expect(vo.equals(notValueObject as unknown as ValueObject<string>)).toBe(false);
    });
    ...
    it('should return false when comparing with null or undefined', () => {
      ...
      expect(vo.equals(undefined as unknown as ValueObject<string>)).toBe(false);
    });
    ...
    it('should handle different types of value objects', () => {
      ...
      expect(stringVo.equals(numberVo as unknown as ValueObject<string>)).toBe(false);
    });
  });
