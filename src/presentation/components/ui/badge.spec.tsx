...
describe('Badge Component Snapshots', () => {
  ...
  describe('customization', () => {
    it('renders badge with custom className', () => {
      const { container } = render(<Badge className="custom-badge">Custom Badge</Badge>);
      expect(container.firstChild).toMatchSnapshot();
    });
  ...
  describe('accessibility', () => {
    it('renders badge with aria-label', () => {
      const { container } = render(<Badge aria-label="Status indicator">5</Badge>);
      expect(container.firstChild).toMatchSnapshot();
    });

    it('renders badge with aria-describedby', () => {
      const { container } = render(<Badge aria-describedby="badge-help">Status</Badge>);
      expect(container.firstChild).toMatchSnapshot();
    });
