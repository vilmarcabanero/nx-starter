...
export const TodoItem: React.FC<TodoItemProps> = ({ todo }) => {
  ...
  return (
    <Card className={cn("mb-2 transition-opacity", viewModel.isUpdating && "opacity-50")} data-testid="todo-item">
          ...
          {viewModel.isEditing ? (
            <div className="flex-1 flex gap-2">
              <Input
                ...
                onChange={(e) => viewModel.handleEditTitleChange(e.target.value)}
