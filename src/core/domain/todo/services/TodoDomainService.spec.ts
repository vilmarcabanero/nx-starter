...
describe('TodoDomainService', () => {
  ...
  describe('calculateUrgencyScore', () => {
    ...
    it('should handle todos with different priorities', () => {
      const highPriorityTodo = new Todo('High', false, baseTodo.createdAt, 1, 'high');
      const mediumPriorityTodo = new Todo('Medium', false, baseTodo.createdAt, 2, 'medium');
      const lowPriorityTodo = new Todo('Low', false, baseTodo.createdAt, 3, 'low');
  ...
  describe('canComplete', () => {
    it('should allow completion of incomplete todos', () => {
      const incompleteTodo = new Todo('Incomplete', false, currentDate, 1, 'medium');
    ...
    it('should not allow completion of already completed todos', () => {
      const completedTodo = new Todo('Completed', true, currentDate, 1, 'medium');
  ...
  describe('sortByPriority', () => {
    it('should sort incomplete todos by urgency score (highest first)', () => {
      const todos = [
        new Todo('Low priority', false, currentDate, 1, 'low'),
        new Todo('High priority', false, currentDate, 2, 'high'),
        new Todo('Medium priority', false, currentDate, 3, 'medium'),
      ];
    ...
    it('should place completed todos at the bottom', () => {
      const todos = [
        new Todo('Incomplete low', false, currentDate, 1, 'low'),
        new Todo('Completed high', true, currentDate, 2, 'high'),
        new Todo('Incomplete high', false, currentDate, 3, 'high'),
        new Todo('Completed medium', true, currentDate, 4, 'medium'),
      ];
    ...
    it('should consider age in sorting', () => {
      const todos = [
        new Todo('New high', false, currentDate, 1, 'high'),
        new Todo('Old medium', false, new Date('2024-06-29T10:00:00Z'), 2, 'medium'), // 14 days old
      ];
    ...
    it('should not mutate the original array', () => {
      const todos = [
        new Todo('Second', false, currentDate, 1, 'low'),
        new Todo('First', false, currentDate, 2, 'high'),
      ];
    ...
    it('should handle single todo', () => {
      const todos = [new Todo('Single', false, currentDate, 1, 'medium')];
    ...
    it('should use current date when no date provided', () => {
      const todos = [
        new Todo('Low priority', false, new Date(), 1, 'low'),
        new Todo('High priority', false, new Date(), 2, 'high'),
      ];
  ...
  describe('integration scenarios', () => {
    it('should handle complex sorting scenario with mixed completion and urgency', () => {
      ...
      const todos = [
        new Todo('Completed old high', true, new Date('2024-06-01T10:00:00Z'), 1, 'high'),
        new Todo('Active new low', false, new Date('2024-06-30T10:00:00Z'), 2, 'low'),
        new Todo('Active old medium', false, new Date('2024-06-15T10:00:00Z'), 3, 'medium'),
        new Todo('Completed recent medium', true, new Date('2024-06-28T10:00:00Z'), 4, 'medium'),
        new Todo('Active new high', false, new Date('2024-06-30T10:00:00Z'), 5, 'high'),
      ];
