...
describe('TodoQueries', () => {
  ...
  describe('GetFilteredTodosQuery', () => {
    ...
    it('should allow all sort options', () => {
      const priorityQuery: GetFilteredTodosQuery = { filter: 'all', sortBy: 'priority' };
      const createdAtQuery: GetFilteredTodosQuery = { filter: 'all', sortBy: 'createdAt' };
      const urgencyQuery: GetFilteredTodosQuery = { filter: 'all', sortBy: 'urgency' };
