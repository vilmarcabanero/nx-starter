...
const TestForm = ({ onSubmit = () => {} }: { onSubmit?: (data: unknown) => void }) => {
  const form = useForm({
    defaultValues: {
      testField: '',
    },
...
describe('Form Components', () => {
  ...
  describe('FormItem', () => {
    ...
    it('should accept custom className', () => {
      ...
      const formItem = screen.getByText('Custom form item').closest('[data-slot="form-item"]');
    ...
    it('should generate unique ids for each FormItem', () => {
      ...
      const item1 = screen.getByTestId('item-1').closest('[data-slot="form-item"]');
      const item2 = screen.getByTestId('item-2').closest('[data-slot="form-item"]');
  ...
  describe('FormDescription', () => {
    ...
    it('should accept custom className', () => {
      ...
      expect(description).toHaveClass('custom-description-class', 'text-sm', 'text-muted-foreground');
    });
  });
  ...
  describe('FormMessage', () => {
    ...
    it('should handle error with no message (return null)', async () => {
      ...
      const messageElement = container.querySelector('[data-slot="form-message"]');
    ...
    it('should accept custom className', () => {
      ...
      expect(message).toHaveClass('custom-message-class', 'text-destructive', 'text-sm');
    });
  });
