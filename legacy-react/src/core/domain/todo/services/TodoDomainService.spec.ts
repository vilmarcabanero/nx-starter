...
describe('TodoDomainService', () => {
  ...
  describe('calculateUrgencyScore', () => {
    it('should return 0 for completed todos', () => {
      ...
      const score = TodoDomainService.calculateUrgencyScore(completedTodo, currentDate);
    ...
    it('should calculate score based on priority for new todos', () => {
      ...
      const score = TodoDomainService.calculateUrgencyScore(newTodo, currentDate);
    ...
    it('should increase score based on age', () => {
      ...
      const score = TodoDomainService.calculateUrgencyScore(oldTodo, currentDate);
    ...
    it('should cap age weight at 3x multiplier', () => {
      ...
      const score = TodoDomainService.calculateUrgencyScore(veryOldTodo, currentDate);
    ...
    it('should handle todos with different priorities', () => {
      const highPriorityTodo = new Todo('High', false, baseTodo.createdAt, generateTestUuid(1), 'high');
      const mediumPriorityTodo = new Todo('Medium', false, baseTodo.createdAt, generateTestUuid(2), 'medium');
      const lowPriorityTodo = new Todo('Low', false, baseTodo.createdAt, generateTestUuid(3), 'low');

      const highScore = TodoDomainService.calculateUrgencyScore(highPriorityTodo, currentDate);
      const mediumScore = TodoDomainService.calculateUrgencyScore(mediumPriorityTodo, currentDate);
      const lowScore = TodoDomainService.calculateUrgencyScore(lowPriorityTodo, currentDate);
    ...
    it('should use default priority when priority is undefined', () => {
      ...
      const score = TodoDomainService.calculateUrgencyScore(todoWithoutPriority, currentDate);
  ...
  describe('canComplete', () => {
    it('should allow completion of incomplete todos', () => {
      const incompleteTodo = new Todo('Incomplete', false, currentDate, generateTestUuid(1), 'medium');
    ...
    it('should not allow completion of already completed todos', () => {
      const completedTodo = new Todo('Completed', true, currentDate, generateTestUuid(1), 'medium');
  ...
  describe('sortByPriority', () => {
    it('should sort incomplete todos by urgency score (highest first)', () => {
      const todos = [
        new Todo('Low priority', false, currentDate, generateTestUuid(1), 'low'),
        new Todo('High priority', false, currentDate, generateTestUuid(2), 'high'),
        new Todo('Medium priority', false, currentDate, generateTestUuid(3), 'medium'),
      ];
    ...
    it('should place completed todos at the bottom', () => {
      const todos = [
        new Todo('Incomplete low', false, currentDate, generateTestUuid(1), 'low'),
        new Todo('Completed high', true, currentDate, generateTestUuid(2), 'high'),
        new Todo('Incomplete high', false, currentDate, generateTestUuid(3), 'high'),
        new Todo('Completed medium', true, currentDate, generateTestUuid(4), 'medium'),
      ];
    ...
    it('should consider age in sorting', () => {
      const todos = [
        ...
        new Todo('Old medium', false, new Date('2024-06-29T10:00:00Z'), generateTestUuid(2), 'medium'), // 14 days old
      ];
    ...
    it('should handle single todo', () => {
      const todos = [new Todo('Single', false, currentDate, generateTestUuid(1), 'medium')];
    ...
    it('should use current date when no date provided', () => {
      const todos = [
        ...
        new Todo('High priority', false, new Date(), generateTestUuid(2), 'high'),
      ];
  ...
  describe('integration scenarios', () => {
    it('should handle complex sorting scenario with mixed completion and urgency', () => {
      ...
      const todos = [
        new Todo('Completed old high', true, new Date('2024-06-01T10:00:00Z'), generateTestUuid(1), 'high'),
        new Todo('Active new low', false, new Date('2024-06-30T10:00:00Z'), generateTestUuid(2), 'low'),
        new Todo('Active old medium', false, new Date('2024-06-15T10:00:00Z'), generateTestUuid(3), 'medium'),
        new Todo('Completed recent medium', true, new Date('2024-06-28T10:00:00Z'), generateTestUuid(4), 'medium'),
        new Todo('Active new high', false, new Date('2024-06-30T10:00:00Z'), generateTestUuid(5), 'high'),
      ];
