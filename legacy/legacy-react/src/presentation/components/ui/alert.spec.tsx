...
describe('Alert Component Snapshots', () => {
  ...
  describe('Alert components', () => {
    ...
    it('renders AlertDescription alone', () => {
      const { container } = render(<AlertDescription>Standalone description text.</AlertDescription>);
      expect(container.firstChild).toMatchSnapshot();
    });
  ...
  describe('customization', () => {
    ...
    it('renders AlertTitle with custom className', () => {
      const { container } = render(<AlertTitle className="custom-title">Custom Title</AlertTitle>);
      expect(container.firstChild).toMatchSnapshot();
    });
    ...
    it('renders Alert with custom aria attributes', () => {
      const { container } = render(
        <Alert aria-labelledby="alert-title" aria-describedby="alert-desc">
          ...
          <AlertDescription id="alert-desc">This alert has proper accessibility attributes.</AlertDescription>
        </Alert>
      );
      expect(container.firstChild).toMatchSnapshot();
    });
    ...
    it('renders Alert with long description', () => {
      const { container } = render(
        <Alert>
          ...
          <AlertDescription>
            This is a very long alert description that contains multiple sentences and should test how the component handles longer content. It includes various types of information and formatting.
          </AlertDescription>
        </Alert>
      );
      expect(container.firstChild).toMatchSnapshot();
    ...
    it('renders Alert with HTML content in description', () => {
      const { container } = render(
        <Alert>
          ...
          <AlertDescription>
            <p>This description contains <strong>bold text</strong> and <em>italic text</em>.</p>
