...
describe('Input Component Snapshots', () => {
  describe('input types', () => {
    ...
    it('renders password input', () => {
      const { container } = render(<Input type="password" placeholder="Enter password..." />);
      expect(container.firstChild).toMatchSnapshot();
    });

    it('renders number input', () => {
      const { container } = render(<Input type="number" placeholder="Enter number..." />);
      expect(container.firstChild).toMatchSnapshot();
    });
  ...
  describe('input attributes', () => {
    it('renders input with custom id', () => {
      const { container } = render(<Input id="custom-id" placeholder="Custom ID" />);
      expect(container.firstChild).toMatchSnapshot();
    });

    it('renders input with name attribute', () => {
      const { container } = render(<Input name="username" placeholder="Username" />);
      expect(container.firstChild).toMatchSnapshot();
    });

    it('renders input with max length', () => {
      const { container } = render(<Input maxLength={50} placeholder="Max 50 characters" />);
      expect(container.firstChild).toMatchSnapshot();
    });

    it('renders input with min/max for numbers', () => {
      const { container } = render(<Input type="number" min={0} max={100} placeholder="0-100" />);
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  ...
  describe('customization', () => {
    it('renders input with custom className', () => {
      const { container } = render(<Input className="custom-input" placeholder="Custom styling" />);
      expect(container.firstChild).toMatchSnapshot();
    });

    it('renders input with aria-invalid', () => {
      const { container } = render(<Input aria-invalid="true" placeholder="Invalid input" />);
      expect(container.firstChild).toMatchSnapshot();
    });

    it('renders input with aria-describedby', () => {
      const { container } = render(<Input aria-describedby="help-text" placeholder="With help text" />);
      expect(container.firstChild).toMatchSnapshot();
    });
  });
