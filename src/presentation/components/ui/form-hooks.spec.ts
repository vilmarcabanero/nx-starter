...
describe('Form Hooks', () => {
  ...
  describe('useFormField', () => {
    ...
    it('should handle missing item context gracefully', () => {
      ...
      expect(result.current.formDescriptionId).toBe('undefined-form-item-description');
    ...
    it('should handle special characters in field name', () => {
      ...
      expect(mockUseFormState).toHaveBeenCalledWith({ name: 'field.with-special_chars[0]' });
    });
    ...
    it('should handle special characters in id', () => {
      ...
      expect(result.current.formItemId).toBe('test-id_with.special-chars-form-item');
      expect(result.current.formDescriptionId).toBe('test-id_with.special-chars-form-item-description');
      expect(result.current.formMessageId).toBe('test-id_with.special-chars-form-item-message');
    });
    ...
    it('should maintain consistency across re-renders', () => {
      ...
      expect(firstResult.formDescriptionId).toBe(secondResult.formDescriptionId);
